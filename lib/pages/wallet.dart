import 'package:dwallet/components/nft_balances.dart';
import 'package:dwallet/components/send_tokens.dart';
import 'package:dwallet/pages/createorimport.dart';
import 'package:dwallet/providers/walletprovider.dart';
import 'package:dwallet/utils/get_balances.dart';
              ...
              Column(
                children: [
                  FloatingActionButton(
                    ...
                    onPressed: () {
                      loadWalletData(); // Refresh wallet data when pressed
                    },
